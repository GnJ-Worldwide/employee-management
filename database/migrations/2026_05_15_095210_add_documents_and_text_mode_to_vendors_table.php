...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('vendors', function (Blueprint $table) {
            // Mode and Text for existing PAN document
            $table->string('pan_document_mode')->default('file')->after('pan_document_path');
            $table->text('pan_document_text')->nullable()->after('pan_document_mode');

            // Mode and Text for existing GST certificate
            $table->string('gst_certificate_mode')->default('file')->after('gst_certificate_path');
            $table->text('gst_certificate_text')->nullable()->after('gst_certificate_mode');
    ...
    public function down(): void
    {
        Schema::table('vendors', function (Blueprint $table) {
            $table->dropColumn([
                'pan_document_mode', 'pan_document_text',
                'gst_certificate_mode', 'gst_certificate_text',
